...
! function(t, e) {
    ...
    E.prototype = {
        ...
        once: function(t, e, i) {
            ...
            function listener() {
                n.off(t, listener), e.apply(i, arguments)
            }
            return listener._ = e, this.on(t, listener, i)
        },
        emit: function(t) {
    ...
    var t = E,
        e = "undefined" != typeof Element ? Element.prototype : {},
        i = e.matches || e.matchesSelector || e.webkitMatchesSelector || e.mozMatchesSelector || e.msMatchesSelector || e.oMatchesSelector,
        n = function match(t, e) {
            if (!t || 1 !== t.nodeType) return !1;
            if (i) return i.call(t, e);
            for (var n = t.parentNode.querySelectorAll(e), s = 0; s < n.length; s++)
                if (n[s] == t) return !0;
            return !1
        };
    var s = function throttle(t, e) {
        var i, n, s, o, r = 0;
        return function throttled() {
            i = this, n = arguments;
            var t = new Date - r;
            return o || (t >= e ? call() : o = setTimeout(call, e - t)), s
        };
    ...
    var o = function() {
            function Point(t, e) {
                _classCallCheck(this, Point), this.x = getNumber(t), this.y = getNumber(e)
            }
        ...
        r = function() {
            function Rect(t, e, i, n, s) {
                _classCallCheck(this, Rect), this.id = s, this.left = t, this.top = e, this.width = i, this.height = n
            }
        ...
        a = 0,
        u = function() {
            function ShuffleItem(t) {
                _classCallCheck(this, ShuffleItem), a += 1, this.id = a, this.element = t, this.isVisible = !0, this.isHidden = !1
            }
            return _createClass(ShuffleItem, [{
                key: "show",
                value: function show() {
                    this.isVisible = !0, this.element.classList.remove(l.HIDDEN), this.element.classList.add(l.VISIBLE), this.element.removeAttribute("aria-hidden")
                }
            }, {
                key: "hide",
                value: function hide() {
                    this.isVisible = !1, this.element.classList.remove(l.VISIBLE), this.element.classList.add(l.HIDDEN), this.element.setAttribute("aria-hidden", !0)
                }
            }, {
                key: "init",
                value: function init() {
                    this.addClasses([l.SHUFFLE_ITEM, l.VISIBLE]), this.applyCss(ShuffleItem.Css.INITIAL), this.scale = ShuffleItem.Scale.VISIBLE, this.point = new o
                }
            }, {
                key: "addClasses",
                ...
                value: function dispose() {
                    this.removeClasses([l.HIDDEN, l.VISIBLE, l.SHUFFLE_ITEM]), this.element.removeAttribute("style"), this.element = null
                }
            }]), ShuffleItem
        }();
    u.Css = {
    ...
    var h = null,
        f = function() {
            ...
            return e.style.cssText = "width:10px;padding:2px;box-sizing:border-box;", t.appendChild(e), h = "10px" === window.getComputedStyle(e, null).width, t.removeChild(e), h
        };

    function getNumberStyle(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : window.getComputedStyle(t, null),
            n = getNumber(i[e]);
        return f() || "width" !== e ? f() || "height" !== e || (n += getNumber(i.paddingTop) + getNumber(i.paddingBottom) + getNumber(i.borderTopWidth) + getNumber(i.borderBottomWidth)) : n += getNumber(i.paddingLeft) + getNumber(i.paddingRight) + getNumber(i.borderLeftWidth) + getNumber(i.borderRightWidth), n
    }
    var c = {
        reverse: !1,
        by: null,
    ...
    function cancelTransitionEnd(t) {
        return !!d[t] && (d[t].element.removeEventListener(m, d[t].listener), d[t] = null, !0)
    }
    ...
    function onTransitionEnd(t, e) {
        var i = function uniqueId() {
            ...
            n = function listener(t) {
                t.currentTarget === t.target && (cancelTransitionEnd(i), e(t))
            };
        return t.addEventListener(m, n), d[i] = {
            element: t,
            listener: n
        }, i
    }
    ...
    function getAvailablePositions(t, e, i) {
        if (1 === e) return t;
        for (var n = [], s = 0; s <= i - e; s++) n.push(arrayMax(t.slice(s, s + e)));
        return n
    }
        ...
        return Object.keys(i).forEach(function(t) {
            ...
            if (f > 0) {
                ...
                (d = o.every(function(t) {
                    var e = new r(t.left + f, t.top, t.width, t.height, t.id),
                        i = !n.some(function(t) {
            ...
            n = n.concat(c), l.push(c)
        }), [].concat.apply([], l).sort(function(t, e) {
            return t.id - e.id
        }).map(function(t) {
            return new o(t.left, t.top)
        })
    }
    ...
    var y = 0,
        g = function(e) {
            function Shuffle(t) {
                ...
                _classCallCheck(this, Shuffle), (e = _possibleConstructorReturn(this, _getPrototypeOf(Shuffle).call(this))).options = Object.assign({}, Shuffle.options, i), e.options.delimeter && (e.options.delimiter = e.options.delimeter), e.lastSort = {}, e.group = Shuffle.ALL_ITEMS, e.lastFilter = Shuffle.ALL_ITEMS, e.isEnabled = !0, e.isDestroyed = !1, e.isInitialized = !1, e._transitions = [], e.isTransitioning = !1, e._queue = [];
                var n = e._getElementOption(t);
                if (!n) throw new TypeError("Shuffle needs to be initialized with an element.");
                return e.element = n, e.id = "shuffle_" + y, y += 1, e._init(), e.isInitialized = !0, e
            }
            return function _inherits(t, e) {
            ...
            }(Shuffle, t), _createClass(Shuffle, [{
                key: "_init",
                value: function _init() {
                    if (this.items = this._getItems(), this.options.sizer = this._getElementOption(this.options.sizer), this.element.classList.add(Shuffle.Classes.BASE), this._initItems(this.items), this._onResize = this._getResizeFunction(), window.addEventListener("resize", this._onResize), "complete" !== document.readyState) {
                        var t = this.layout.bind(this);
                        window.addEventListener("load", function onLoad() {
                            window.removeEventListener("load", onLoad), t()
                        })
                    }
                ...
                value: function setItemTransitions(t) {
                    var e = this.options,
                        ...
                        o = Object.keys(u.Css.HIDDEN.before).map(function(t) {
                ...
                value: function _getItems() {
                    ...
                    return Array.from(this.element.children).filter(function(e) {
                        return n(e, t.options.itemSelector)
                    }).map(function(t) {
                        return new u(t)
                    })
                }
                ...
                value: function _getColumnSize(t, e) {
                    var i;
                    return 0 === (i = "function" == typeof this.options.columnWidth ? this.options.columnWidth(t) : this.options.sizer ? Shuffle.getSize(this.options.sizer).width : this.options.columnWidth ? this.options.columnWidth : this.items.length > 0 ? Shuffle.getSize(this.items[0].element, !0).width : t) && (i = t), i + e
                }
            }, {
                key: "_getGutterSize",
                ...
                value: function _layout(t) {
                    ...
                    t.forEach(function(t, s) {
                        function callback() {
                            t.applyCss(u.Css.VISIBLE.after)
                        }
                        if (o.equals(t.point, i[s]) && !t.isHidden) return t.applyCss(u.Css.VISIBLE.before), void callback();
                        t.point = i[s], t.scale = u.Scale.VISIBLE, t.isHidden = !1;
                        var r = e.getStylesForTransition(t, u.Css.VISIBLE.before);
                ...
                value: function _getNextPositions(t) {
                    ...
                    if (this.options.isCentered) {
                        var i = t.map(function(t, i) {
                            ...
                            return new r(s.x, s.y, n.width, n.height, i)
                        });
                ...
                value: function _getItemPosition(t) {
                    return function getItemPosition(t) {
                        for (var e = t.itemSize, i = t.positions, n = t.gridSize, s = t.total, r = t.threshold, l = t.buffer, a = getColumnSpan(e.width, n, s, r), u = getAvailablePositions(i, a, s), h = getShortColumn(u, l), f = new o(n * h, u[h]), c = u[h] + e.height, d = 0; d < a; d++) i[h + d] = c;
                        return f
                    }({
                        itemSize: t,
                ...
                value: function _shrink() {
                    ...
                    e.forEach(function(e) {
                        ...
                        if (e.isHidden) return e.applyCss(u.Css.HIDDEN.before), void callback();
                        e.scale = u.Scale.HIDDEN, e.isHidden = !0;
                        var n = t.getStylesForTransition(e, u.Css.HIDDEN.before);
                        n.transitionDelay = t._getStaggerAmount(i) + "ms", t._queue.push({
                            item: e,
                            styles: n,
                            callback: callback
                        }), i += 1
                ...
                value: function _processQueue() {
                    ...
                    e && t && this.isInitialized ? this._startTransitions(this._queue) : e ? (this._styleImmediately(this._queue), this._dispatch(Shuffle.EventType.LAYOUT)) : this._dispatch(Shuffle.EventType.LAYOUT), this._queue.length = 0
                }
            }, {
                ...
                value: function _startTransitions(t) {
                    ...
                    this.isTransitioning = !0,
                        function parallel(t, e, i) {
                            i || ("function" == typeof e ? (i = e, e = null) : i = noop);
                            var n = t && t.length;
                            if (!n) return i(null, []);
                            var s = !1,
                                o = new Array(n);
                ...
                value: function _cancelMovement() {
                    this._transitions.forEach(cancelTransitionEnd), this._transitions.length = 0, this.isTransitioning = !1
                }
            }, {
                ...
                value: function _movementFinished() {
                    this._transitions.length = 0, this.isTransitioning = !1, this._dispatch(Shuffle.EventType.LAYOUT)
                }
            }, {
                key: "filter",
                value: function filter(t, e) {
                    this.isEnabled && ((!t || t && 0 === t.length) && (t = Shuffle.ALL_ITEMS), this._filter(t), this._shrink(), this._updateItemCount(), this.sort(e))
                }
            }, {
                key: "sort",
                value: function sort() {
                ...
                value: function add(t) {
                    ...
                    var n = sorter(this._mergeNewItems(i), this.lastSort),
                        ...
                        r = function applyHiddenState(t) {
                            t.scale = u.Scale.HIDDEN, t.isHidden = !0, t.applyCss(u.Css.HIDDEN.before), t.applyCss(u.Css.HIDDEN.after)
                        },
                ...
                value: function remove(t) {
                    ...
                    if (t.length) {
                        ...
                        this._toggleFilterClasses({
                            ...
                            return !n.includes(t)
                        }), this._updateItemCount(), this.once(Shuffle.EventType.LAYOUT, function handleLayout() {
                ...
                value: function resetItems() {
                    var t = this;
                    this._disposeItems(this.items), this.isInitialized = !1, this.items = this._getItems(), this._initItems(this.items), this.once(Shuffle.EventType.LAYOUT, function() {
                ...
                value: function getSize(t) {
                    ...
                    e && (n += getNumberStyle(t, "marginLeft", i) + getNumberStyle(t, "marginRight", i), s += getNumberStyle(t, "marginTop", i) + getNumberStyle(t, "marginBottom", i));
                    return {
                        width: n,
                        height: s
                    }
    ...
    return g.ShuffleItem = u, g.ALL_ITEMS = "all", g.FILTER_ATTRIBUTE_KEY = "groups", g.EventType = {
        LAYOUT: "shuffle:layout",
        REMOVED: "shuffle:removed"
    }, g.Classes = l, g.FilterMode = {
        ANY: "any",
        ALL: "all"
    }, g.options = {
        group: g.ALL_ITEMS,
        ...
        isCentered: !1,
        roundTransforms: !0
    }, g.Point = o, g.Rect = r, g.__sorter = sorter, g.__getColumnSpan = getColumnSpan, g.__getAvailablePositions = getAvailablePositions, g.__getShortColumn = getShortColumn, g.__getCenteredPositions = getCenteredPositions, g
});
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
 * Package:  cv@0.2.2
