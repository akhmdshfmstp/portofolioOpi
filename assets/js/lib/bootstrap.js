...
function(t) {
    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.prototype.close = function(e) {
        ...
        e && e.preventDefault(), s.length || (s = o.closest(".alert")), s.trigger(e = t.Event("close.bs.alert")), e.isDefaultPrevented() || (s.removeClass("in"), t.support.transition && s.hasClass("fade") ? s.one("bsTransitionEnd", removeElement).emulateTransitionEnd(i.TRANSITION_DURATION) : removeElement())
    };
    var o = t.fn.alert;
...
function(t) {
    ...
    var i = t.fn.button;
    t.fn.button = Plugin, t.fn.button.Constructor = e, t.fn.button.noConflict = function() {
...
function(t) {
    ...
    function Plugin(i) {
        return this.each(function() {
            ...
            n || o.data("bs.carousel", n = new e(this, s)), "number" == typeof i ? n.to(i) : r ? n[r]() : s.interval && n.pause().cycle()
        })
    }
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 600, e.DEFAULTS = {
        ...
        if (this.$element.trigger(d), !d.isDefaultPrevented()) {
            ...
            return t.support.transition && this.$element.hasClass("slide") ? (s.addClass(i), s[0].offsetWidth, n.addClass(a), s.addClass(a), n.one("bsTransitionEnd", function() {
                s.removeClass([i, a].join(" ")).addClass("active"), n.removeClass(["active", a].join(" ")), l.sliding = !1, setTimeout(function() {
                    l.$element.trigger(c)
                }, 0)
            }).emulateTransitionEnd(e.TRANSITION_DURATION)) : (n.removeClass("active"), s.addClass("active"), this.sliding = !1, this.$element.trigger(c)), r && this.cycle(), this
        }
    };
    var i = t.fn.carousel;
    t.fn.carousel = Plugin, t.fn.carousel.Constructor = e, t.fn.carousel.noConflict = function() {
...
function(t) {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (!(o && o.length && (i = o.data("bs.collapse")) && i.transitioning)) {
                ...
                if (this.$element.trigger(n), !n.isDefaultPrevented()) {
                    o && o.length && (Plugin.call(o, "hide"), i || o.data("bs.collapse", null));
                    ...
                    this.$element.one("bsTransitionEnd", t.proxy(r, this)).emulateTransitionEnd(e.TRANSITION_DURATION)[s](this.$element[0][a])
                }
            }
        }
    ...
    var i = t.fn.collapse;
    t.fn.collapse = Plugin, t.fn.collapse.Constructor = e, t.fn.collapse.noConflict = function() {
...
function(t) {
    ...
    function clearMenus(o) {
        o && 3 === o.which || (t(e).remove(), t(i).each(function() {
            ...
            i.hasClass("open") && (o && "click" == o.type && /input|textarea/i.test(o.target.tagName) && t.contains(i[0], o.target) || (i.trigger(o = t.Event("hide.bs.dropdown", n)), o.isDefaultPrevented() || (e.attr("aria-expanded", "false"), i.removeClass("open").trigger(t.Event("hidden.bs.dropdown", n)))))
        }))
    }
    o.VERSION = "3.3.7", o.prototype.toggle = function(e) {
        ...
        if (/(38|40|27|32)/.test(e.which) && !/input|textarea/i.test(e.target.tagName)) {
            ...
            if (e.preventDefault(), e.stopPropagation(), !o.is(".disabled, :disabled")) {
                var n = getParent(o),
                    s = n.hasClass("open");
                if (!s && 27 != e.which || s && 27 == e.which) return 27 == e.which && n.find(i).trigger("focus"), o.trigger("click");
                var r = n.find(".dropdown-menu li:not(.disabled):visible a");
                if (r.length) {
                    var a = r.index(e.target);
                    38 == e.which && a > 0 && a--, 40 == e.which && a < r.length - 1 && a++, ~a || (a = 0), r.eq(a).trigger("focus")
                }
            }
        }
    };
...
function(t) {
    ...
    function Plugin(i, o) {
        return this.each(function() {
            ...
            s || n.data("bs.modal", s = new e(this, r)), "string" == typeof i ? s[i](o) : r.show && s.show(o)
        })
    }
...
function(t) {
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        if (this.$element.trigger(s), !s.isDefaultPrevented()) return n.removeClass("in"), t.support.transition && n.hasClass("fade") ? n.one("bsTransitionEnd", complete).emulateTransitionEnd(e.TRANSITION_DURATION) : complete(), this.hoverState = null, this
    ...
    var i = t.fn.tooltip;
    t.fn.tooltip = function Plugin(i) {
        return this.each(function() {
            var o = t(this),
                n = o.data("bs.tooltip"),
                s = "object" == typeof i && i;
...
function(t) {
    ...
    var i = t.fn.popover;
    t.fn.popover = function Plugin(i) {
        return this.each(function() {
            var o = t(this),
                n = o.data("bs.popover"),
                s = "object" == typeof i && i;
...
function(t) {
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 150, e.prototype.show = function() {
        ...
        function next() {
            s.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded", !1), i.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded", !0), r ? (i[0].offsetWidth, i.addClass("in")) : i.removeClass("fade"), i.parent(".dropdown-menu").length && i.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded", !0), n && n()
        }
        s.length && r ? s.one("bsTransitionEnd", next).emulateTransitionEnd(e.TRANSITION_DURATION) : next(), s.removeClass("in")
    };
    var i = t.fn.tab;
